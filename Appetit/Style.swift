...
public struct Style: StyleProvider {
    ...
    public let tintColor: UIColor = Style.orange
    public let shadowColor: UIColor = Style.transparentBlack
    
    public let title1: UIFont = UIFont.systemFont(ofSize: 42, weight: UIFontWeightHeavy)
    public let title2: UIFont = UIFont.systemFont(ofSize: 28, weight: UIFontWeightSemibold)
    ...
    static let orange = UIColor(red: 255/255, green: 114/255, blue: 32/255, alpha: 1)
