...
public class ListOrder: UIView {
    ...
    public var viewModel: ListOrderViewModelProtocol = ListOrderViewModel() {
        didSet {
            updateView()
        }
    }
    ...
    func setUp()
    {
        ...
        cancelButton.addTarget(self,
                               action: #selector(ListOrder.cancelTap),
                               for: .touchUpInside)
        ...
        saveButton.addTarget(self,
                             action: #selector(ListOrder.saveTap),
                             for: .touchUpInside)
